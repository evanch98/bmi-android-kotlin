...
class BmiCalculatorTest {
  @Test
  fun resultTest1() {
    val bmiCalculator = BmiCalculator(136, 67.0, "male")
  ...
  @Test
  fun resultTest2() {
    var bmiCalculator = BmiCalculator(90, 67.0, "female")
    val result: BmiResult = bmiCalculator.getResult()
  ...
  @Test
  fun resultTest3() {
    var bmiCalculator = BmiCalculator(180, 67.0, "male")
    val result: BmiResult = bmiCalculator.getResult()
  ...
  @Test
  fun resultTest4() {
    var bmiCalculator = BmiCalculator(200, 67.0, "male")
    val result: BmiResult = bmiCalculator.getResult()
